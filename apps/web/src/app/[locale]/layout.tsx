            ...
            <div className="container mx-auto px-4 py-2.5">
              <div className="flex items-center justify-between">
                ...
                <nav className="hidden md:flex items-center space-x-8">
                  <Link href={`/${locale}`} className="text-gray-700 hover:text-brand-teal transition-all duration-200 font-semibold text-base hover:scale-105">
                    Ana Sayfa
                  </Link>
                  <Link href={`/${locale}/calculator`} className="text-gray-700 hover:text-brand-teal transition-all duration-200 font-semibold text-base hover:scale-105">
                    Hesaplama
                  </Link>
                </nav>
          ...
          <footer className="border-t mt-16">
            <div className="container mx-auto px-4 py-8">
              <div className="text-center text-sm text-muted-foreground">
                <p className="mb-2">
                  Sosyal Konut App - Açık kaynak sosyal konut karar destek aracı
                </p>
                <p className="text-xs">
                  Bu araç bilgilendirme amaçlıdır. Resmi veriler için{' '}
                  <a
